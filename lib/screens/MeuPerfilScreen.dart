                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          InkWell(
                            splashColor: Colors
                                .transparent, // Remove o efeito de ondulação
                            highlightColor:
                                Colors.transparent, // Remove a cor de destaque
                            onTap: () async {
                              if (editable == true) {
                                File? foto;
                                if (fotoPerfil != null) {
                                  final http.Response response =
                                      await http.get(Uri.parse(fotoPerfil!));
